...
class AutoDerivedEquivalenceSuite extends CirceSuite {
  ...
  object magnolia {
    ...
    implicit val magnoliaEncoder13 = tag[Magnolia](Encoder[List[Foo]])
    ...
    implicit val magnoliaDecoder13 = tag[Magnolia](Decoder[List[Foo]])
  ...
  object circe {
    ...
    implicit val circeEncoder13 = tag[Circe](Encoder[List[Foo]])
    ...
    implicit val circeDecoder13 = tag[Circe](Decoder[List[Foo]])
  ...
  checkLaws("Codec[List[Foo]]", CodecEquivalenceTests[List[Foo]].codecEquivalence)
